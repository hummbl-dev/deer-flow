# KRINEIA.md — deer-flow

**krineia_manifest_version:** 0.1
**schema:** krineia-manifest@0.1

This is the repo-local KRINEIA manifest for `hummbl-dev/deer-flow`.
...
repo:
  full_name: "hummbl-dev/deer-flow"
  visibility: "public"
  status: "archived"
...
governance_profile:
  ...
  fork_of: "bytedance/deer-flow"

chains:
  primary:
    chain_id: "deer-flow-primary"
...
This repository is an archived fork of `bytedance/deer-flow`. No KRINEIA chain is bootstrapped. If this fork is ever un-archived and brought into active development, it must:
